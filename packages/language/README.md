...
- [src/foda-ms.langium](src/foda-ms.langium) -  The grammar definition of your language
- [src/foda-ms-module.ts](src/foda-ms-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/foda-ms-validator.ts](src/foda-ms-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/foda-ms.monarch.ts](src/syntaxes/foda-ms.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/foda-ms.tmLanguage.json](syntaxes/foda-ms.tmLanguage.json) - Textmate based syntax highlighting instructions.
